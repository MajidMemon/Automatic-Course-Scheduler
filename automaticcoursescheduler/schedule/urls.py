...
from . import views
from schedule.views import Pdf
...
urlpatterns = [
    ...
    path('view_pdf/<int:schedule_id>/', views.view_pdf, name='view_pdf'),

    path('test_schedule/', views.detect_conflicts, name='test_schedule'),

    path('upload/', views.upload_csv, name='upload_schedule_for_sort'),
    path('view/', views.view_schedule, name='view_sorted_schedule'),
]
if settings.DEBUG:
